...
type platform = "X" | "facebook" | "linkedin" | "telegram";
...
export default function SocialShare() {
  ...
  const sharePlatform = (platform: platform) => {
    const urls = {
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="flex items-center justify-center gap-2 bg-[#4267B2]/10 hover:bg-[#0088cc]/20 text-[#4267B2] p-3 rounded-lg transition-colors"
        >
